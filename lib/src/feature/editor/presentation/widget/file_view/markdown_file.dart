...
import 'package:dial_editor/src/feature/editor/presentation/provider/file_provider.dart';
...
class _MarkdownFileState extends ConsumerState<MarkdownFile>
  ...
  void initState() {
    super.initState();
    file = ref.watch(fileProvider).value!;
...
class CustomTextSelectionGestureDetectorBuilder
  ...
  final _MarkdownFileState _state;
  final int _index;
  CustomTextSelectionGestureDetectorBuilder({
    required _MarkdownFileState state,
    required int index,
  })  : _state = state,
        _index = index,
